...
async function loadPB(obj){let{beginPathbuilderImport}=await import('/modules/pathbuilder2e-import/pathbuilder-import.js');beginPathbuilderImport(obj,true)}
