...
async function performExportToHV(targetActor) {
  try {
    ...
    if (hvDebug)
      console.log(
        "%cHeroVau.lt/Foundry Bridge | %ccan access?: " + canOverwrite,
        hvColor1,
        hvColor4
      );
    if (freeSlots < 1 && canOverwrite == false) {
      ...
      new Dialog({
        ...
        close: async (html) => {
          if (exportNewPC) {
            hvUID = "";
            let exportStatus = await exportPCtoHVSlug(
              targetActor,
              hvUserToken,
              hvUID,
              true,
    ...
    theseItems.forEach((v, k) => {
      ...
      if (item.type == "lore") {
        let loreItem = {
          ...
          type: "lore",
          name: item.name,
          proficient: item.data.proficient.value,
        };
        itemExport.push(loreItem);
      } else if (item.type == "spellcastingEntry") {
        let spellSlotData = {
          0: item.data.slots.slot0.max,
          1: item.data.slots.slot1.max,
          2: item.data.slots.slot2.max,
          3: item.data.slots.slot3.max,
          4: item.data.slots.slot4.max,
          5: item.data.slots.slot5.max,
          6: item.data.slots.slot6.max,
          7: item.data.slots.slot7.max,
          8: item.data.slots.slot8.max,
          9: item.data.slots.slot9.max,
          10: item.data.slots.slot10.max,
          11: item.data.slots.slot11.max,
        };
        let spellCastingEntryItem = {
          ...
          name: item.name,
          slug: item.data.slug,
          ability: item.data.ability.value,
          proficiency: item.data.proficiency.value,
          focusPoints: item.data.focus.points,
          tradition: item.data.tradition.value,
          prepared: item.data.prepared.value,
          showunprep: item.data.showUnpreparedSpells.value,
        ...
        let spellItem = {
          ...
          slug: item.data.slug,
          prepared: item.data.prepared.value,
          level: item.data.level.value,
          location: item.data.location.value,
        };
        ...
        let armorWeaponItem = {
          ...
          name: item.name,
          slug: item.data.slug,
          potencyRune: item.data.potencyRune.value,
          preciousMaterial: item.data.preciousMaterial.value,
          preciousMaterialGrade: item.data.preciousMaterialGrade.value,
          price: item.data.price.value,
          propertyRune1: item.data.propertyRune1.value,
          propertyRune2: item.data.propertyRune2.value,
          propertyRune3: item.data.propertyRune3.value,
          propertyRune4: item.data.propertyRune4.value,
          resiliencyRune: item.data.resiliencyRune.value,
          propertyRune4: item.data.propertyRune4.value,
          quantity: item.data.quantity.value,
          equipped: item.data.equipped.value,
          invested: item.data.invested.value,
          containerid: item.data.containerId.value,
          identified: item.data.identification.status,
        };
        ...
        if (
          item.data.slug.includes("scroll") &&
          item.name.includes("(Level ")
        ) {
          let thisItem = {
            id: item._id,
            type: item.type,
